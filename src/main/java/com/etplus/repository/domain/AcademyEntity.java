...
public class AcademyEntity {
  ...
  public AcademyEntity(Long id, String name, String description, LocationType locationType,
      String detailedAddress, boolean forKindergarten, boolean forElementary,
      boolean forMiddleSchool,
      boolean forHighSchool, boolean forAdult) {
    this.id = id;
    this.name = name;
